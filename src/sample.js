...
var fabriceHumanObject = { name: "Fabrice Reynolds", gender: "male" }
var shagunHumanObject = { name: "Shagun Madhikarmi", gender: "male" }
console.log(typeof(fabriceHumanObject))
console.log(typeof(shagunHumanObject))

console.log(fabriceHumanObject)
console.log(fabriceHumanObject.name)
console.log(fabriceHumanObject.gender)

// Array of objects
var humanObjects = [ fabriceHumanObject, shagunHumanObject ]
...
var token =  {
    "access_token": "4WdutNlqVBbcK7Y3TQtesjQ0yLhnre",
    "expires_in": 2419200,
    "token_type": "Bearer",
    "scope": "read write",
    "refresh_token": "p08DWXh5wPXA9qOF3dVxWqCgNo2clB"
}
console.log(token)
